...
[app_servers:vars]
ansible_user=ubuntu
ansible_ssh_common_args='-o ProxyCommand="ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -W %h:%p -q ubuntu@${module.compute.bastion_public_ip}" -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null'
