...
ansible_ssh_common_args='-o ProxyCommand="ssh -i $SSH_AUTH_SOCK -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -W %h:%p -q ubuntu@${module.compute.bastion_public_ip}" -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null'
